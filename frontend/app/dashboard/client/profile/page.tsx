...
import { AlertCircle, User, Building2, Briefcase, Mail, Phone, CheckCircle, XCircle, Clock } from "lucide-react";
...
export default async function ClientProfilePage() {
  ...
  // Fetch the user's profile to verify they are a client
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">View your profile, designation, and organization details</p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-lg font-semibold">{profile.designation || "N/A"}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <div>
                {organization?.client_type ? (
                  <Badge variant="outline">{organization.client_type}</Badge>
                ) : "N/A"}
              </div>
            </div>
          </CardContent>
